...
public class PlayerSprite : BaseGameObject
{
    ...
    {
        AddBoundingBox(new Engine2D.Objects.Collisions.BoundingBox(new Vector2(BB1PosX, BB1PosY), BB1Width, BB1Height));
        AddBoundingBox(new Engine2D.Objects.Collisions.BoundingBox(new Vector2(BB2PosX, BB2PosY), BB2Width, BB2Height));
